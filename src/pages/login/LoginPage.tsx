    ...
    <div className="min-h-screen bg-white dark:bg-black flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          {/* Header */}
          <Link to="/" className="flex gap-2 items-center hover:text-indigo-500"> <ArrowLeft/> back to home</Link>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-500 dark:via-purple-500 dark:to-pink-500 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          ...
          <p className="text-xl text-center text-white/90 max-w-md">
            Empowering skilled, disciplined and future-ready engineers for
